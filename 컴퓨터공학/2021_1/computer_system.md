...
![cpu](/Users/taetae/Desktop/memomemo/memojang/컴퓨터공학/2021_1/cpu.GIF)
...
1. 연산 기능     :  사칙연산, 시프트, 보수, 논리 연산(and,or,not)
2. 데이터 전달기능 : 레지스터 -> 레지스터, 레지스터 -> 주기억 장치
3. 제어 기능     : 조건 분기, 무조건 분기 명령어로 실행순서 제어
4. 입출력 기능    : 연산결과 -> 출력장치, 데이터 -> 주기억 장치

  - 주소필드

1. 기억장치의 주소, 숫자, 문자, 논리 데이터 등 저장
